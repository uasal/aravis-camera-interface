...
static const GOptionEntry cameraCommandOptionEntries[] =
{
	...
	{ "stream-time", 'd', 0, G_OPTION_ARG_INT64, &streamTime, "Time that the camera streams for, in microseconds (not equivalent to the video duration, which depends on performance of the camera and the datarate of the ethernet connection)", NULL },
